...
% Forward Flight
theta_LR_F_1 = [theta_LR_H_1, 0.1815, 0.1900, 0.1791, 0.1706, theta_LR_t_1, 0.1891];
theta_UR_F_1 = [theta_UR_H_1, 0.1471, 0.1218, 0.1387, 0.1616, theta_UR_t_1, 0.1928];
theta_1s_F_1 = [theta_1s_H_1, -0.0641, -0.0509, -0.0530, -0.0609, theta_1s_t_1, -0.0787];
theta_1c_F_1 = [theta_1c_H_1, 0.0125, -0.0158, -0.0276, -0.0350, theta_1c_t_1, -0.0323];
phi_F_1      = [phi_H_1, 0.0105, 0.0290, 0.0249, 0.0157, phi_t_1, 0.0147];
theta_F_1    = [theta_H_1, 0.0598, -0.0065, -0.0124, 0.0039, theta_t_1, 0.0113];
delta_E_F_1  = [delta_E_H_1, -7.7478e-04, 3.7814e-04, 0.0021, -0.0023, delta_E_t_1, -0.0113];
...
% Forward Flight
theta_LR_F_2 = [theta_LR_H_2, 0.1875, 0.1727, 0.1626, 0.1667, theta_LR_t_2, 0.1828];
theta_UR_F_2 = [theta_UR_H_2, 0.1046, 0.1035, 0.1227, 0.1356, theta_UR_t_2, 0.1790];
theta_1s_F_2 = [theta_1s_H_2, -0.0483, -0.0381, -0.0403, -0.0458, theta_1s_t_2, -0.0651];
theta_1c_F_2 = [theta_1c_H_2, 0.0057, -0.0154, -0.0250, -0.0314, theta_1c_t_2, -0.0196];
phi_F_2      = [phi_H_2, 0.0244, 0.0353, 0.0316, 0.0349, phi_t_2, 0.0204];
theta_F_2    = [theta_H_2, 0.0199, -0.0260, -0.0245, -0.0285, theta_t_2, 0.0068];
delta_E_F_2  = [delta_E_H_2, -3.9828e-04, 0.0013, 0.0055, -6.4829e-05, delta_E_t_2, -0.0055];
delta_R_F_2  = [delta_R_H_2, 0.0012, -0.0015, -4.2132e-04, 3.0026e-04, delta_R_t_2, 5.4554e-04];
...
% Forward Flight
theta_LR_F_3 = [theta_LR_H_3, 0.1899, 0.1750, 0.1636, 0.1654, theta_LR_t_3, 0.1826];
theta_UR_F_3 = [theta_UR_H_3, 0.1073, 0.1059, 0.1258, 0.1404, theta_UR_t_3, 0.1807];
theta_1s_F_3 = [theta_1s_H_3, -0.0503, -0.0395, -0.0416, -0.0475, theta_1s_t_3, -0.0662];
theta_1c_F_3 = [theta_1c_H_3, 0.0065, -0.0155, -0.0253, -0.0318, theta_1c_t_3, -0.0217];
phi_F_3      = [phi_H_3, 0.0237, 0.0342, 0.0293, 0.0299, phi_t_3, 0.0194];
theta_F_3    = [theta_H_3, 0.0235, -0.0233, -0.0208, -0.0192, theta_t_3, 0.0082];
delta_E_F_3  = [delta_E_H_3, -3.7100e-04, 0.0012, 0.0045, -8.3416e-05, delta_E_t_3, -0.0065];
delta_R_F_3  = [delta_R_H_3, 0.0123, 0.0011, 3.7219e-04, 6.2712e-04, delta_R_t_3, 7.0276e-04];
...
% Forward Flight
theta_LR_F_4 = [theta_LR_H_4, 0.1900, 0.1770, 0.1657, 0.1665, theta_LR_t_4, 0.1833];
theta_UR_F_4 = [theta_UR_H_4, 0.1113, 0.1078, 0.1274, 0.1427, theta_UR_t_4, 0.1822];
theta_1s_F_4 = [theta_1s_H_4, -0.0519, -0.0411, -0.0432, -0.0494, theta_1s_t_4, -0.0679];
theta_1c_F_4 = [theta_1c_H_4, 0.0070, -0.0156, -0.0256, -0.0322, theta_1c_t_4, -0.0232];
phi_F_4      = [phi_H_4, 0.0225, 0.0337, 0.0288, 0.0285, phi_t_4, 0.0189];
theta_F_4    = [theta_H_4, 0.0278, -0.0211, -0.0196, -0.0163, theta_t_4, 0.0090];
delta_E_F_4  = [delta_E_H_4, -3.7034e-04, 0.0011, 0.0039, -2.2232e-04, delta_E_t_4, -0.0079];
delta_R_F_4  = [delta_R_H_4, 0.0210, 0.0032, 0.0010, 9.3069e-04, delta_R_t_4, 8.4456e-04];
