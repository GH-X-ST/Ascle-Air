function xdot = stateDerivative(state, ctrl_trans, params)
% Introduction:
...
%   theta_0    - Average rotor collective (rad)
%   theta_diff - Rotor collective difference (rad)
...
% ctrl_trans - [theta_0, theta_diff, theta_1s, theta_1c, delta_E, delta_R]
theta_0    = ctrl_trans(1);
theta_diff = ctrl_trans(2);
theta_1s   = ctrl_trans(3);
theta_1c   = ctrl_trans(4);
delta_E    = ctrl_trans(5);
delta_R    = ctrl_trans(6);

theta_LR = theta_0 - theta_diff;
theta_UR = theta_0 + theta_diff;
