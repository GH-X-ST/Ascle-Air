...
% 0.1 Initial guess
x0 = [0.2788; 0.2323; deg2rad(-3); 0; 0; 0; deg2rad(0); deg2rad(0)];
...
function F = trimResiduals(x)
    ...
    %lb = [0; 0; deg2rad(-5); deg2rad(-0.5); deg2rad(-5); deg2rad(-5); deg2rad(-10); deg2rad(-10)];
    %ub = [deg2rad(20); deg2rad(20); 0; deg2rad(0.5); deg2rad(5); deg2rad(5); deg2rad(10); deg2rad(10)];
